namespace TN01___WFCadastroContato
{
    public partial class Form1 : Form
    {
        ...
        private void CarregarLista()
        {
            ...
            Contato.ListaContatos.Add(new Contato
                {Codigo = 1,Nome = "Ana",Sobrenome = "Silva",DDD = "11",Telefone = "987654321",TipoTelefone = ETipoTelefone.Pessoal,Email = "ana.silva@email.com"}
            );
